<form id="form-document" style="padding-inline: 0px;" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <input type="text" class="form-input fs-7" id="documentname" name="documentname" value="<?= $row['documentname'] ?? '' ?>" placeholder="@ex: Admin Staff" required>
    </div>
    <div class="form-group">
        <?php if ($form_type == 'edit') { ?>
    ...
    <?php if ($form_type == 'edit') { ?>
        ...
        <input type="text" class="form-input fs-7" id="description" name="description" value="<?= $row['description'] ?? '' ?>" placeholder="@ex: admin##" required>
        <?php } ?>
